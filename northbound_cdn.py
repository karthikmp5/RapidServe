...
def create_cdn(existing_tenants=None, tenant_name='default'):
    ...
    tenant = {
        ...
        'origin_replication_region': questionary.select("Where do you want to replicate the origin server?", choices=['singapore', 'Dubai', 'greece', 'ireland']).ask()
...
def get_additional_edge_containers_info():
    ...
    if need_additional:
        ...
        regions = questionary.checkbox("Which all regions do you want them?", choices=['singapore', 'Dubai', 'greece', 'ireland']).ask()
